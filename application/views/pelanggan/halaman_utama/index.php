<!-- home -->
<section class="section section--bg section--carousel section--first" data-bg="<?= base_url('assets/') ?>img/bg.jpg" style="padding-top: 110px;">
    <div class="container">
        <div class="row">
            <!-- title -->
            <div class="col-12">
                    ...
                    <div class="section__nav-wrap">
                        <button class="section__nav section__nav--bg section__nav--prev" type="button" data-nav="#carousel0">
                            <svg xmlns='http://www.w3.org/2000/svg' width='512' height='512' viewBox='0 0 512 512'>
                                <polyline points='328 112 184 256 328 400' style='fill:none;stroke-linecap:round;stroke-linejoin:round;stroke-width:48px' /></svg>
                        </button>

                        <button class="section__nav section__nav--bg section__nav--next" type="button" data-nav="#carousel0">
                            <svg xmlns='http://www.w3.org/2000/svg' width='512' height='512' viewBox='0 0 512 512'>
                                <polyline points='184 112 328 256 184 400' style='fill:none;stroke-linecap:round;stroke-linejoin:round;stroke-width:48px' /></svg>
                        </button>
                    </div>
                </div>
            </div>
        ...
        <?php foreach ($data_barang as $Data_barang) : ?>
            <div class="card card--big">
                <a href="<?= base_url('detail_barang/' . $Data_barang->id_barang . '') ?>" class="card__cover">
                    <img src="<?= base_url('assets/') ?>images/products/<?= $Data_barang->gambar_barang ?>" width="20%" alt="">
                </a>
