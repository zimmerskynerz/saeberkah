        ...
        <div class="row">
            <div class="col-12">
                <div class="section__wrap">
                    <!-- section title -->
                    <h2 class="section__title">Konfirmasi Transaksi Diterima</h2>
                    <!-- end section title -->
                    <!-- end breadcrumb -->
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="form form--checkout">
                    <h3>Konfirmasi Terima Barang</h3>
                    <input type="text" class="form__input" id="id_pemesanan" hidden value="<?= $id_pemesanan ?>" name="id_pemesanan" required>
                    <button type="submit" id="konfirmasi_terima" name="konfirmasi_terima" class="form__btn">Konfirmasi</button>
                </div>
                <?php echo form_close(); ?>
                <!-- end checkout -->
            </div>
